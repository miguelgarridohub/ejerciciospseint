...
Funcion num<- max(num1,num2)
	...
	Si num1>num2 Entonces//se estaba comparando num1>num1
		num<-num1;
	SiNo
		num<-num2;	
	FinSi
...
//################################################################################
//Función IncializarTablero: Función que recibe las dos tablas: tablero, visible
...
Funcion EscribirTablero(tablero,visible)
	...
	Escribir "";
	//Recorro las tablas
	Para fila<-0 hasta 9 Hacer//Cambiado de 10 a 9
		Escribir sin saltar subcadena(titfilas,fila,fila),"   ";
		Para colum<-0 hasta 9 Hacer//Cambiado de 10 a 9
